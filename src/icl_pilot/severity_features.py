...
_COLUMN_DECISIONS: dict[str, tuple[str, str, str]] = {
    ...
    "Syntax_Utts_Analyzed": ("drop", "syntax_qc", "Support count for syntax extraction coverage; retained in the master archive only."),
    "Syntax_Tokens_Analyzed": ("drop", "syntax_qc", "Support count for syntax extraction coverage; retained in the master archive only."),
    "Syntax_Mean_DepLen": ("keep", "syntax_feature", "Mean non-punctuation dependency length from %ugra."),
    "Syntax_Max_DepLen": ("keep", "syntax_feature", "Maximum non-punctuation dependency length from %ugra."),
    "Syntax_Mean_TreeDepth": ("keep", "syntax_feature", "Mean token tree depth from %ugra dependency trees."),
    "Syntax_Max_TreeDepth": ("keep", "syntax_feature", "Maximum token tree depth from %ugra dependency trees."),
    "Syntax_Subordination_Utt_Prop": ("keep", "syntax_feature", "Proportion of utterances with clausal subordination relations such as ccomp/xcomp/advcl/acl."),
    "Syntax_Coordination_Utt_Prop": ("keep", "syntax_feature", "Proportion of utterances with coordination relations."),
    "Syntax_Subject_Utt_Prop": ("keep", "syntax_feature", "Proportion of utterances with overt subject relations."),
    "Syntax_Object_Utt_Prop": ("keep", "syntax_feature", "Proportion of utterances with direct or indirect object relations."),
    "Syntax_AuxCop_Utt_Prop": ("keep", "syntax_feature", "Proportion of utterances with auxiliary or copular support."),
    "Syntax_Oblique_Utt_Prop": ("keep", "syntax_feature", "Proportion of utterances with oblique arguments or adjuncts."),
    "Syntax_ComplexNP_Utt_Prop": ("keep", "syntax_feature", "Proportion of utterances with complex nominal modification."),
    "Syntax_FiniteVerb_Tokens_per_Utt": ("keep", "syntax_feature", "Finite verbal segments per analyzed utterance based on %umor."),
    ...
    "syntax_source": ("drop", "provenance", "Syntax feature provenance column; keep only in archive table."),
