...
def main():
  ...
  # Walk through all subdirectories to find .cex files
  for root, dirs, files in os.walk(cex_dir):
  ...
  print(f"Found {len(file_data)} files with error data_original")
